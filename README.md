...
**彭雨诗律师**，上海市华诚律师事务所合伙人律师、专利代理师、中级知识产权师。毕业于中国政法大学（法学学士）、美国康奈尔大学（法学硕士）、浙江工业大学（计算机工学学士），兼具法律与计算机专业背景。专注于知识产权民商事争议解决与权利保护。积极探索 AI 技术在法律实务中的应用与开发，致力于推动法律工作流的智能化。
...
2. **法律分析 Skills** — 面向具体法律业务的 Claude Code Skills（后续发布）
