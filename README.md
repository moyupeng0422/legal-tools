...
| 工具 | 说明 | 许可证 | 版本 | 使用条件 | 详情 |
|------|------|--------|------|----------|------|
| **文书细节校对 Skill** | 法律文书 AI 校对流水线：M1~M8 八模块（机械规则 + AI 语义双引擎）校对起诉状/合同/催告函等，输出 Word 原生 Track Changes + 批注；locate_issues.py 实现"AI 出判断、脚本管定位"，多命中拒绝输出强制消歧；含漏检案例自我进化机制与回归测试 | MIT | v1.0.0 | 纯 Python 可跑（OOXML 路径无需 Word）；COM 路径需 Windows + Word | [目录](%E6%96%87%E4%B9%A6%E7%BB%86%E8%8A%82%E6%A0%A1%E5%AF%B9/) |
