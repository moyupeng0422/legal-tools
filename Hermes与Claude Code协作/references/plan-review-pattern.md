...
2. SCP to Windows: `scp -P <SSH_端口> /tmp/file.md <Windows_用户名>@local-win:"C:/Users/<Windows_用户名>/file.md"`
3. Send CC a short instruction to read the file: "读 C:\Users\<Windows_用户名>\file.md，这是 Hermes 第 N 轮审查意见"
